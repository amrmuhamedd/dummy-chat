...
let contacts: ContactTypes[] = [
  {
    ...
    firstName: "Amr",
    lastName: "Mohamed",
    about: "Eiusmod quis cupidatat irure voluptate mollit magna irure quis cillum dolore.",
    email: "amr@test.com",
  ...
  },
  {
    ...
    about: "Ut laborum laboris nulla ex labore exercitation. Incididunt duis officia sit elit.",
    email: "sara@test.com",
  ...
  },
  {
    ...
    firstName: "lamiaa",
    lastName: "salah",
    about: "Esse aliqua aute commodo in et veniam reprehenderit minim anim exercitation ipsum",
    email: "lamiaa@test.com",
    location: "Cairo , Egypt",
    status: STATUS_TYPES.ACTIVE,
    channels: [
      {
